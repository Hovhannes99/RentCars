...
export const Phone: FC<Props & { withIcon?: boolean; animate?: boolean }> = ({
  withIcon,
  animate,
  ...contactProps
}) => (
...
export const WhatsApp = ({ text, ...props }: Props & { text?: string }) => (
  <ContactWay
...
export const Telegram: FC<Props & { text?: string }> = ({ text, ...props }) => (
  <ContactWay
...
export const Instagram: FC<Props & { text?: string }> = ({
  text,
  ...props
}) => (
  <ContactWay
